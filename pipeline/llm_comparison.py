...
def compare_predictions(data, correct_ids, gpt4_ids, gpt4_urls, llama2_ids, llama2_urls):
    ...
    for i, (entry, correct_id, gpt4_id, llama2_id, gpt4_url, llama2_url) in enumerate(
        ...
        if missed_id_gpt4 and missed_id_llama2:
            common_missed.append(
                (i, entry["utterance"], correct_id, missed_id_gpt4, gpt4_url, missed_id_llama2, llama2_url)
            )
        elif missed_id_gpt4:
            gpt4_only_missed.append((i, entry["utterance"], correct_id, missed_id_gpt4, gpt4_url))
        elif missed_id_llama2:
            llama2_only_missed.append((i, entry["utterance"], correct_id, missed_id_llama2, llama2_url))
...
def compare_llm_predictions(correct_ids, llama2_ids, model, dataset, dataset_file_path):
    ...
    common_missed, gpt4_only_missed, llama2_only_missed = compare_predictions(
        data, correct_ids, gpt4_ids, gpt4_urls, llama2_ids, llama2_urls
    )
